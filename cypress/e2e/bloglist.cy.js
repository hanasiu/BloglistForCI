describe("Blog app", function () {
    ...
    describe("When logged in", function () {
        ...
        //     cy.contains("second blog - jane").click();
        //     cy.contains("second blog - jane").find("#remove-button").click();
        ...
        //         cy.contains("third blog").parent().should("not.contain", "remove");
        //         cy.contains("third blog").parent().find("#hide-button").click();
        //     });
